...
{
    public class SfDataGridPageViewModel<T> : BindableBase
    {
        ...
        public ObservableCollection<T> Animals { get; set; }

        public SfDataGridPageViewModel()
        {
            this.Name = "Hi, William";
            Animals = new ObservableCollection<T>();
