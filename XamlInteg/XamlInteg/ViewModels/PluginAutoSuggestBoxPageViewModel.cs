...
{
    public class PluginAutoSuggestBoxPageViewModel : ViewModelBase
    {
        private ObservableCollection<Monkey> monkeys;

        public ObservableCollection<Monkey> Monkeys { get => monkeys; set => SetProperty(ref monkeys, value); }

        #region Constructor

        public PluginAutoSuggestBoxPageViewModel(INavigationService navigationService, IPageDialogService pageDialogService)
            : base(navigationService, pageDialogService)
        {
            this.Title = "AutoSuggestBox";
